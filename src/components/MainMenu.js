...
function MainMenu(props) {
  return (
    <div className="font-Lexen">
        <h2 onClick={props.create} className="duration-75 text-5xl md:text-5xl my-10 text-white hover:-translate-y-2 hover:text-primary cursor-pointer font-bold">Créer une partie</h2>
